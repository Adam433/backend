...
export default function ArchivesAddrecord() {
  ...
  useEffect(() => {
    axios.get('http://localhost:7890/staff?rolesId=1&rolesId=2').then(res => {
      setStaff(res.data)
    })
    axios.get('http://localhost:7890/inStocks').then(res => {
      setInstock(res.data)
    })
  ...
  const handleOk = () => {
    ...
    axios.post(`http://localhost:7890/records`, obj).then(res => {
