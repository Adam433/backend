      ...
      >
        ...
        <Dropdown overlay={menu}>
          <span className='avatar'>
            <Avatar src="http://p0.itc.cn/images01/20201218/03697d2d279144c0a4b05e4cb2016aae.jpeg" />
          </span>
        </Dropdown>
      </Header>
      <Modal title="退出登陆" 
      visible={isModalVisible} onOk={handleOk} onCancel={handleCancel} okType='danger'  >
        <p>是否退出登陆？</p>
      </Modal>
    </div>
  )
